...
public class Strings {
    ...
    public static final String nomeArquivoLog = "Relato de Importacao.txt";

    public static final String nomeArquivoImportar =
            "Egressos-para-Importar.txt";

    public static final String barraLateralEnderecoArquivo = "\\";
}
